                    ...
                    <tr>
                        ...
                        <td class="style33">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="Blue" Text="User Login "></asp:Label>
                        </td>
                        <td class="style30">
                            </td>
                        <td class="style30">
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#0033CC" Text="Username"></asp:Label>
                            <br />
                        </td>
                        <td class="style21">
                        ...
                        <td class="style10">
                            <asp:TextBox ID="TextBox1" PlaceHolder="Enter the Username" runat="server" 
                                BackColor="#0066FF" Font-Bold="True" 
                    ...
                    <tr>
                        ...
                        <td class="style6">
                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#0033CC" Text="Password"></asp:Label>
                            <br />
                        </td>
                        <td class="style22">
                    ...
                    <tr>
                        ...
                        <td class="style27">
                            <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
                                PostBackUrl="~/Register.aspx" CausesValidation="False" ForeColor="Maroon" OnClick="LinkButton1_Click">New User ? Sign Up Here.</asp:LinkButton>
                            </td>
                        <td class="style28">
                            </td>
                        <td class="style29">
                            <asp:Button ID="Button1" runat="server" BackColor="#33CCCC" BorderStyle="Ridge" 
                                Font-Bold="True" ForeColor="Black" Height="32px" Text="Login" 
                                Width="91px" onclick="Button1_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button2" runat="server" BackColor="#CC0000" BorderStyle="Ridge" 
                                Font-Bold="True" ForeColor="Black" Height="32px" Text="Reset" 

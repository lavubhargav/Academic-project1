<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TMfiles.aspx.cs" Inherits="TMfiles" %>
                    ...
                    <tr>
                        ...
                        <td class="style45">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="Blue" Text="Verify the Transactions"></asp:Label>
                            </td>
                        <td class="style46">
                            </td>
                        <td class="style47">
                    ...
                    <tr>
                        ...
                        <td class="style20">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                Height="73px" onrowcommand="GridView1_RowCommand" Width="342px">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT [FileID], [Username], [Filename], [extension] FROM [fileupload] WHERE ([PolicyVerify] &lt;&gt; @PolicyVerify)">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="NO" Name="PolicyVerify" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                        <td class="style3">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TMLogin.aspx.cs" Inherits="TMLogin" %>
            ...
            <asp:Panel ID="Panel2" runat="server" Height="686px">
                <table class="style2">
                    <tr>
                        ...
                        <td class="style33">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="Blue" Text="Transaction Manager Login"></asp:Label>
                        </td>
                        <td class="style30">
                            </td>
                        <td class="style30">
                    ...
                    <tr>
                        ...
                        <td class="style7">
                            <asp:TextBox ID="TextBox2" PlaceHolder="Enter the Password" runat="server" BackColor="#3366FF" Font-Bold="True" 
                    ...
                    <tr>
                        ...
                        <td class="style29">
                            <asp:Button ID="Button1" runat="server" BackColor="#99CCFF" BorderStyle="Ridge" 
